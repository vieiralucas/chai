describe('utilities', function () {
  ...
  describe('overwriteMethod', function () {
    ...
    it('should return a new assertion with flags copied over', function () {
      ...
      var assertion2 = assertion1.is.four();
      ...
      // Test chaining `.length` after the method to guarantee it is not a function's `length`
      expect('four').to.be.a.four().with.length.above(2);

      expect(expect('four').be).to.be.an.instanceOf(assertionConstructor);
